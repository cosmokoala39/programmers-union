...
type ArticleWidgetGridProps = {
  data: Record<string, Article[]>;
  categories: string[];
};

export default function ArticleWidgetGrid({ data, categories }: ArticleWidgetGridProps) {
  return (
    <div className="row">
      {categories.map((category) => {
        ...
        return (
          <div className="col-12 col-md-3 mb-4" key={category}>
            {/* Category Title */}
